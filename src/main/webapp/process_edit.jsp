<%-- 
    ...
    Created on : Nov 8, 2025, 10:19:29 AM
    Author     : ADMIN
--%>
...
<%
    ...
    try {
        ...
        if (rowsAffected > 0) {
            ...
            response.sendRedirect("edit_students.jsp?id=" + studentId + "&error=Update failed");
        }
        
    } catch (Exception e) {
        response.sendRedirect("edit_students.jsp?id=" + studentId + "&error=Error occurred");
        e.printStackTrace();
    } finally {
        try {
